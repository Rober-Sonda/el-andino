...
import { Package, Clock, CheckCircle, Truck, Info, MessageCircle, Edit, XCircle, Tag } from 'lucide-react';
                ...
                <div key={order.id} style={{background: 'var(--glass-bg)', borderRadius: '16px', border: `1px solid var(--glass-border)`, overflow: 'hidden', boxShadow: '0 4px 15px rgba(0,0,0,0.05)'}}>
                  <div style={{padding: '1.2rem 1.5rem', background: 'var(--glass-bg)', borderBottom: '1px solid var(--glass-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px'}}>
                    ...
                    <div>
                      ...
                      {order.discountAmount > 0 && <span style={{fontSize:'0.75rem', color:'#ef4444', marginLeft:'5px'}}>-${order.discountAmount} desc.</span>}
                    </div>
                  ...
                  <div style={{padding: '1.5rem'}}>
                    <div style={{display: 'flex', flexDirection: 'column', gap: '0.8rem', marginBottom: '1.5rem'}}>
                      ...
                      {order.discountAmount > 0 && (
                        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderTop: '2px solid var(--glass-border)', paddingTop: '0.8rem', marginTop: '0.5rem'}}>
                          <div style={{color: '#ef4444', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '5px'}}>
                            <Tag size={16} /> Descuento aplicado
                          </div>
                          <strong style={{color: '#ef4444'}}>-${order.discountAmount}</strong>
                        </div>
                      )}
                    </div>
