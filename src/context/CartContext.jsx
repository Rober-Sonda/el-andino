...
export const CartProvider = ({ children }) => {
  ...
  const DEFAULT_CATALOG = {
    ...
    'blend-herencia': {
      ...
      category: 'blends',
      description: 'Base Premium • Pura Hoja • Molienda media. Equilibrio entre el estacionamiento premium y la intensidad de la hoja pura despalada. Esta fusión crea un mate de textura suave, un sabor más ligero y con un rendimiento excepcional.',
      image: '/kraft_bag.png',
      isOrganic: true,
      isSinTacc: true,
      isAntiacid: true,
    ...
    'blend-fuego': {
      ...
      category: 'blends',
      description: 'Base Barbacuá • Toques Premium • Con palo. Intensa base ahumada barbacuá equilibrada con sutiles hojas puras y premium. Brinda un sabor profundo, cuerpo robusto y matices leñosos, logrando un mate de gran carácter y persistencia.',
      image: '/kraft_bag.png',
      isOrganic: true,
      isSinTacc: true,
      isAntiacid: true,
    ...
    'blend-charrua': {
      ...
      category: 'blends',
      description: 'Corte Oriental • Molienda fina • Gran espuma. Fusión de molienda fina, hoja pura y un toque premium. Este clásico oriental brinda un mate intenso, logrando un sabor fuerte y bien definido.',
      image: '/kraft_bag.png',
      isOrganic: true,
      isSinTacc: true,
      isAntiacid: true,
    ...
    'blend-alma': {
      ...
      category: 'blends',
      description: 'Base Despalada • Toque Ahumado • Sin palo. Base de pura hoja despalada coronada con sutiles notas ahumadas. El resultado es un mate con un sabor imponente, con matices a leña que logran capturar la verdadera esencia del monte.',
      image: '/kraft_bag.png',
      isOrganic: true,
      isSinTacc: true,
      isAntiacid: true,
