...
# Overlay opacity screen for text contrast
$overlayBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(150, 0, 0, 0))
$graph.FillRectangle($overlayBrush, 0, 0, $targetWidth, $targetHeight)
...
$rect = [System.Drawing.RectangleF]::new(0, $textY, $targetWidth, 100)
$shadowRect = [System.Drawing.RectangleF]::new(5, $textY + 5, $targetWidth, 100)
...
$textSubY = $textY + 85
$rectSub = [System.Drawing.RectangleF]::new(0, $textSubY, $targetWidth, 50)
$shadowRectSub = [System.Drawing.RectangleF]::new(3, $textSubY + 3, $targetWidth, 50)
